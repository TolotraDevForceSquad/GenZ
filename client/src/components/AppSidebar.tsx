    ...
    <Sidebar className="bg-zinc-900 border-r border-zinc-800 text-white">
      <SidebarHeader className="border-b border-zinc-800 p-4">
        <div className="flex items-center gap-3">
          {/* <img src={genZLogo} alt="Gasy Hub" className="w-8 h-8 rounded-full border-2 border-yellow-400 p-0.5" /> */}
          <div>
            <h2 className="text-lg font-extrabold text-yellow-400">Gasy Hub</h2>
            <p className="text-xs text-zinc-400 font-mono">Gasy Miray Hina</p>
          </div>
        </div>
      </SidebarHeader>
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton 
                    ...
                    className="w-full justify-start gap-3 text-white hover:bg-zinc-800 transition-colors duration-200 
                               data-[active=true]:bg-yellow-400 data-[active=true]:text-zinc-900 
                               data-[active=true]:font-bold group"
                    data-testid={`nav-${item.title.toLowerCase().replace(' ', '-')}`}
                  >
                    <item.icon className="w-5 h-5 group-data-[active=true]:text-zinc-900 text-yellow-400 group-hover:text-yellow-300 group-data-[active=true]:group-hover:text-zinc-900" />
          ...
          <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <Badge 
                    className={user.hasCIN 
                      ...
                      : "bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 text-xs font-medium"
                    }
                  >
            ...
            <div className="flex gap-2 border-t border-zinc-800 pt-3">
              <Button 
                variant="ghost" 
                size="sm" 
                className="flex-1 h-8 bg-zinc-800/50 hover:bg-zinc-800 text-white hover:text-yellow-400 transition"
