// storage.ts - Updated with recordView method and alertViews table support
import { type User, type InsertUser, type UpsertUser, type Alert, type InsertAlert, type AlertComment, type InsertAlertComment, type AlertValidation, type UserStats, type SystemStats, type AlertView, type InsertAlertView } from "@shared/schema";
import { users, alerts, alertValidations, alertComments, alertViews } from "@shared/schema";
import { db } from './db';
